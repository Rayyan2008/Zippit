    ...
    <div className="min-h-screen flex items-center justify-center bg-cream p-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-ink/10 p-8">
          ...
          {error && (
            <div className="mb-4 p-4 bg-rouge/10 border border-rouge/20 text-rouge text-sm">
              {error}
            </div>
          )}
          ...
          <p className="text-center text-ink/60 text-sm mt-6">
            ...
            <Link to="/admin/signup" className="text-rouge hover:text-wine underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
