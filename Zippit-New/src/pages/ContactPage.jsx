...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const existingInquiries = JSON.parse(localStorage.getItem('zippit_inquiries') || '[]');
    existingInquiries.push(inquiry);
    localStorage.setItem('zippit_inquiries', JSON.stringify(existingInquiries));
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="name" className="eyebrow text-ink/60 mb-2 block">
                      Name *
                    </Label>
                    <Input
                      id="name"
                  ...
                  <div>
                    <Label htmlFor="email" className="eyebrow text-ink/60 mb-2 block">
                      Email *
                    </Label>
                    <Input
                      id="email"
                  ...
                  <div>
                    <Label htmlFor="phone" className="eyebrow text-ink/60 mb-2 block">
                      Phone (WhatsApp) *
                    </Label>
                    <Input
                      id="phone"
                ...
                <div>
                  <Label htmlFor="subject" className="eyebrow text-ink/60 mb-2 block">
                    Subject
                  </Label>
                  <Input
                    id="subject"
                ...
                <div>
                  <Label htmlFor="message" className="eyebrow text-ink/60 mb-2 block">
                    Message *
                  </Label>
                  <Textarea
                    id="message"
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="bg-white border-ink/15 text-ink placeholder:text-ink/40 resize-none"
